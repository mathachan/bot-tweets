...
from tensorflow.keras.layers import Conv1D,Dense,Embedding,Bidirectional,Dropout
...
model.add(Bidirectional(LSTM(120, return_sequences=True, recurrent_dropout=0.2)))
...
print(model.summary())
filepath="weights_best_bilstm.hdf5"
...
with open("model_bilstm1.json", "w") as json_file:
        json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("bilstm_weight.h5")
